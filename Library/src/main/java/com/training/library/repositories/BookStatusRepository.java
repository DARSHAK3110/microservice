...
public interface BookStatusRepository extends JpaRepository<BookStatus, Long> {
	...
	@Query(value = "select new com.training.library.dto.response.BookStatusResponseDto(bookStatusId, location.locationId,location.shelf.section.floor.floorId, location.shelf.section.sectionId,location.shelf.shelfId,location.shelf.section.floor.floorNo, location.shelf.section.sectionName, location.shelf.shelfNo, location.position, isAvailable, bookDetails.isbn, bookDetails.bookDetailsId,isReserved) from BookStatus where bookDetails.bookDetailsId = :id and deletedAt is null")
	Page<BookStatusResponseDto> findAllByDeletedAtIsNullAndBookDetails_BookDetailsId(Pageable pageble, Long id);

	@Query(value = "select new com.training.library.dto.response.BookStatusResponseDto(bookStatusId, location.locationId,location.shelf.section.floor.floorId, location.shelf.section.sectionId,location.shelf.shelfId,location.shelf.section.floor.floorNo, location.shelf.section.sectionName, location.shelf.shelfNo, location.position, isAvailable, bookDetails.isbn, bookDetails.bookDetailsId, isReserved) from BookStatus where  bookDetails.bookDetailsId = :id and deletedAt is null and :col = TRUE")
	Page<BookStatusResponseDto> findAllByDeletedAtIsNullAndBookDetails_BookDetailsId(Pageable pageble, Long id,
			String col);
	...
	@Query(value = "select new com.training.library.dto.response.BookStatusResponseDto(bookStatusId, location.locationId,location.shelf.section.floor.floorId, location.shelf.section.sectionId,location.shelf.shelfId,location.shelf.section.floor.floorNo, location.shelf.section.sectionName, location.shelf.shelfNo, location.position, isAvailable, bookDetails.isbn, bookDetails.bookDetailsId,isReserved) from BookStatus where location.locationId = :id and deletedAt is null")
	Page<BookStatusResponseDto> findAllByLocationId(Long id, Pageable pageble);

	@Query(value = "select new com.training.library.dto.response.BookStatusResponseDto(bookStatusId, location.locationId,location.shelf.section.floor.floorId, location.shelf.section.sectionId,location.shelf.shelfId,location.shelf.section.floor.floorNo, location.shelf.section.sectionName, location.shelf.shelfNo, location.position, isAvailable, bookDetails.isbn, bookDetails.bookDetailsId,isReserved) from BookStatus where location.shelf.shelfId = :id and deletedAt is null")
	Page<BookStatusResponseDto> findAllByShelfId(Long id, Pageable pageble);

	@Query(value = "select new com.training.library.dto.response.BookStatusResponseDto(bookStatusId, location.locationId,location.shelf.section.floor.floorId, location.shelf.section.sectionId,location.shelf.shelfId,location.shelf.section.floor.floorNo, location.shelf.section.sectionName, location.shelf.shelfNo, location.position, isAvailable, bookDetails.isbn, bookDetails.bookDetailsId, isReserved) from BookStatus where location.shelf.section.sectionId = :id and deletedAt is null")
	Page<BookStatusResponseDto> findAllBySectionId(Long id, Pageable pageble);

	@Query(value = "select new com.training.library.dto.response.BookStatusResponseDto(bookStatusId, location.locationId,location.shelf.section.floor.floorId, location.shelf.section.sectionId,location.shelf.shelfId,location.shelf.section.floor.floorNo, location.shelf.section.sectionName, location.shelf.shelfNo, location.position, isAvailable, bookDetails.isbn, bookDetails.bookDetailsId,isReserved) from BookStatus where location.shelf.section.floor.floorId = :id and deletedAt is null" )
	Page<BookStatusResponseDto> findAllByFloorId(Long id, Pageable pageble);

	@Query(value = "select new com.training.library.dto.response.BookStatusResponseDto(bookStatusId, location.locationId,location.shelf.section.floor.floorId, location.shelf.section.sectionId,location.shelf.shelfId,location.shelf.section.floor.floorNo, location.shelf.section.sectionName, location.shelf.shelfNo, location.position, isAvailable, bookDetails.isbn, bookDetails.bookDetailsId,isReserved) from BookStatus where  bookDetails.isbn = :id and deletedAt is null and isAvailable = True and isReserved = FALSE")
	Page<BookStatusResponseDto> findAllByDeletedAtIsNullAndBookDetails_ISBN(Pageable pageble, Long id);

	@Query(value = "select new com.training.library.dto.response.BookStatusResponseDto(bookStatusId, location.locationId,location.shelf.section.floor.floorId, location.shelf.section.sectionId,location.shelf.shelfId,location.shelf.section.floor.floorNo, location.shelf.section.sectionName, location.shelf.shelfNo, location.position, isAvailable, bookDetails.isbn, bookDetails.bookDetailsId, isReserved) from BookStatus where  bookDetails.bookDetailsId = :id and deletedAt is null and isAvailable = TRUE and isReserved = False")
	Page<BookStatusResponseDto> findAllByDeletedAtIsNullAndBookDetails_BookDetailsIdAndIsAvailableTrue(Pageable pageble,
			Long id);

	@Query(value = "select new com.training.library.dto.response.BookStatusResponseDto(bookStatusId, location.locationId,location.shelf.section.floor.floorId, location.shelf.section.sectionId,location.shelf.shelfId,location.shelf.section.floor.floorNo, location.shelf.section.sectionName, location.shelf.shelfNo, location.position, isAvailable, bookDetails.isbn, bookDetails.bookDetailsId, isReserved) from BookStatus where  bookDetails.bookDetailsId = :id and deletedAt is null and isAvailable = TRUE and isReserved = True")
	Page<BookStatusResponseDto> findAllByDeletedAtIsNullAndBookDetails_BookDetailsIdAndIsReservesTrue(Pageable pageble,
			Long id);
}
