...
public class CustomExceptionHandler {
	...
	public final ResponseEntity<ExceptionResponseDto> AuthenticationCredentialNotFoundExceptionHandler(Exception e) {

		ExceptionResponseDto res = new ExceptionResponseDto("Authentication not found!!", e);
		return new ResponseEntity<>(res, HttpStatus.UNAUTHORIZED);
	}
